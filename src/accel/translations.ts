export const accelTranslations = {
  en: {
    ...
    accelResultViews: 'Result views',
    accelResultSummary: 'Summary',
    accelResultMap: 'Map',
    accelResultCharts: 'Charts',
    accelResultDetails: 'Details',
    accelResultHistory: 'History',
    accelTechnicalData: 'Technical data',
    accelChartMetric: 'Chart metric',
    accelMapLoading: 'Loading route map…',
    accelMapDegraded: 'Map imagery is unavailable. The recorded route is still usable.',
    accelMapError: 'The route map could not be loaded.',
    accelMapEmpty: 'This run does not contain route coordinates.',
    ...
    accelHeroLead:
      'Uses browser geolocation only. Results are estimates based on observed GPS callbacks, not certified timing.',
    accelDisclaimer:
      'Accuracy depends on browser callback rate, GPS quality, visibility state, and device behavior. Use repeated runs and quality grades honestly.',
    ...
    accelAdvanced: 'Advanced',
    accelNotesAdded: 'Notes added',
    accelNoNotes: 'No notes',
    ...
    accelSpeedGraphLeadDistance: 'Distance vs speed',
    ...
    accelReplay: 'Replay',
    accelReplayControls: 'Replay controls',
    accelReplayPlay: 'Play replay',
    accelReplayPause: 'Pause replay',
    accelReplayRestart: 'Restart replay',
    accelReplayAxis: 'Replay axis',
    accelReplayAxisTime: 'Time',
    accelReplayAxisDistance: 'Distance',
    accelReplayProgress: 'Replay progress',
    accelReplayFinish: 'Finish',
    accelReplayMapAria: 'Acceleration replay map',
    accelExploreCharts: 'Explore charts',
    accelReplayDragToExplore: 'Drag across the chart to scrub the replay.',
    accelReplaySpeedChart: 'Replay speed chart',
    accelReplayAltitudeChart: 'Replay altitude chart',
    accelReplayHeadingChart: 'Replay heading chart',
    ...
    accelLeaveActiveRunConfirm: 'An acceleration run is active. Leave and keep it running in the background?',
  ...
  es: {
    ...
    accelPageDescription:
      'Temporizador GPS de aceleracion gratis en navegador para pruebas de 0-60, 60-130, 1/8 de milla, 1/4 de milla y 0-100 km/h. Pensado para Tesla y navegadores moviles modernos con historial local y graficas interactivas.',
    ...
    accelResultViews: 'Vistas del resultado',
    accelResultSummary: 'Resumen',
    accelResultMap: 'Mapa',
    accelResultCharts: 'Graficas',
    accelResultDetails: 'Detalles',
    accelResultHistory: 'Historial',
    accelTechnicalData: 'Datos tecnicos',
    accelChartMetric: 'Metrica de la grafica',
    accelMapLoading: 'Cargando mapa de la ruta…',
    accelMapDegraded: 'Las imagenes del mapa no estan disponibles. La ruta grabada sigue disponible.',
    accelMapError: 'No se pudo cargar el mapa de la ruta.',
    accelMapEmpty: 'Esta corrida no contiene coordenadas de ruta.',
    ...
    accelHeroLead:
      'Usa solo geolocalizacion del navegador. Los resultados son estimaciones basadas en callbacks GPS observados, no tiempos certificados.',
    accelDisclaimer:
      'La precision depende de la frecuencia de callbacks del navegador, la calidad GPS, la visibilidad de la pestaña y el comportamiento del dispositivo. Usa repeticiones y grados de calidad con honestidad.',
    accelStorageNote:
      'Las corridas y ajustes quedan guardados solo en el almacenamiento local de este navegador',
    ...
    accelAdvanced: 'Avanzado',
    accelNotesAdded: 'Notas agregadas',
    accelNoNotes: 'Sin notas',
    ...
    accelSpeedGraphLeadDistance: 'Distancia vs velocidad',
    accelSpeedGraphEmpty:
      'Los datos de la grafica de velocidad estaran disponibles para nuevas corridas.',
    ...
    accelReplay: 'Replay',
    accelReplayControls: 'Controles de replay',
    accelReplayPlay: 'Reproducir replay',
    accelReplayPause: 'Pausar replay',
    accelReplayRestart: 'Reiniciar replay',
    accelReplayAxis: 'Eje del replay',
    accelReplayAxisTime: 'Tiempo',
    accelReplayAxisDistance: 'Distancia',
    accelReplayProgress: 'Progreso del replay',
    accelReplayFinish: 'Final',
    accelReplayMapAria: 'Mapa del replay de aceleracion',
    accelExploreCharts: 'Explorar graficas',
    accelReplayDragToExplore: 'Arrastra sobre la grafica para recorrer el replay.',
    accelReplaySpeedChart: 'Grafica de velocidad del replay',
    accelReplayAltitudeChart: 'Grafica de altitud del replay',
    accelReplayHeadingChart: 'Grafica de rumbo del replay',
    ...
    accelLeaveActiveRunConfirm: 'Hay una corrida de aceleracion activa. Salir y dejarla corriendo en segundo plano?',
