            ...
            <div class="replay-toolbar-right">
              <div class="replay-toolbar-strip">
                <div class="tools-menu replay-tools-menu">
                  <button
                    id="replayToolsMenuBtn"
                    type="button"
                    class="tools-menu-btn replay-toolbar-icon-btn"
                  ...
                  <div id="replayToolsMenuList" class="tools-menu-list" hidden>
                    <div
                      class="compact-tools-menu-brand"
                      data-i18n-title="replayTagline"
                      title="Drive replay by Vatio Libre"
                    >
                      <span class="dot" aria-hidden="true"></span>
                    ...
                    <button id="openReplaySpeedMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="speedometer">Speedometer</span>
                    </button>
                    <button id="openReplayAccelMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="accelerationTest">Acceleration Test</span>
                    </button>
                    <button id="openReplayLibraryMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="cloudLibrary">Cloud library</span>
                    </button>
                    <button id="openReplayBoardMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
