          ...
          >
            <div class="accel-toolbar-actions">
              <div class="accel-toolbar-strip">
                <div class="tools-menu accel-tools-menu">
                  <button
                    id="accelToolsMenuBtn"
                    type="button"
                    class="tools-menu-btn accel-toolbar-btn accel-toolbar-icon-btn accel-toolbar-btn-tools"
                  ...
                  <div id="accelToolsMenuList" class="tools-menu-list" hidden>
                    <div
                      class="compact-tools-menu-brand"
                      data-i18n-title="accelTagline"
                      title="Browser acceleration timer by Vatio Libre"
                    >
                      <span class="dot" aria-hidden="true"></span>
                    ...
                    <button id="openAccelSpeedMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="accelSpeedometer">Speedometer</span>
                    </button>
                    <button id="openAccelLibraryMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="cloudLibrary">Cloud library</span>
                    </button>
                    <button id="openAccelBoardMenu" type="button" class="btn-with-icon">
                      <span class="btn-icon" aria-hidden="true"></span>
                      <span data-i18n="accelOpenBoard">Open board</span>
                    </button>
                    <form class="backend-auth" data-backend-auth novalidate>
                      ...
                      <button
                        type="button"
                        data-backend-auth-logout
                        data-backend-auth-authenticated
