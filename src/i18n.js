...
const baseTranslations = {
  ...
  es: {
    ...
    activitySpeedRecording: 'Grabando viaje',
    activitySpeedAlertsArmed: 'Alertas de velocidad armadas',
    activitySpeedAlertsArming: 'Armando alertas de velocidad',
    activitySpeedAlertsSuppressed: 'Las alertas necesitan rearmarse',
    activitySpeedAlertsBlocked: 'Audio de alertas bloqueado',
    activitySpeedRecordingKeepAliveActive: 'Keep-alive en segundo plano activo',
    activitySpeedRecordingKeepAliveArming: 'Armando keep-alive',
    activitySpeedRecordingKeepAliveNeedsRearm: 'El keep-alive necesita rearmarse',
    activitySpeedRecordingMayNeedResume: 'La grabación puede necesitar reanudarse',
    ...
    activitySamplesShort: '{count} muestras',
    activityGpsActive: 'GPS activo',
    activitySpeedAlertsReady: 'Audio de alertas listo',
