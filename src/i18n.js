...
const baseTranslations = {
  en: {
    ...
    saveLoginRequired: 'Log in to save drawings to VatioLibre.',
    saveSessionCheckFailed: 'Could not verify your session ({status})',
    saveFeatureAccessFailed: 'Could not verify drawing access ({status})',
    saveSubscriptionRequired: 'Saved drawings require an active subscription.',
    saveUnavailable: 'Saved drawings are unavailable right now.',
    ...
    cloudLibraryLead:
      'Browse prior speed replays, accel runs, editable board documents, and saved image exports without restoring your whole cloud history into local storage first.',
    cloudLibrarySpeed: 'Speed',
    cloudLibraryAccel: 'Accel',
    cloudLibraryBoardDocuments: 'Board Documents',
    cloudLibrarySavedImages: 'Saved Images',
  ...
  es: {
    ...
    saveLoginRequired: 'Inicia sesión para guardar dibujos en VatioLibre.',
    saveSessionCheckFailed: 'No se pudo verificar tu sesión ({status})',
    saveFeatureAccessFailed: 'No se pudo verificar el acceso a dibujos ({status})',
    saveSubscriptionRequired: 'Los dibujos guardados requieren una suscripción activa.',
    saveUnavailable: 'Los dibujos guardados no están disponibles en este momento.',
    ...
    cloudLibraryLead:
      'Explora replays de velocidad, corridas de aceleración, documentos editables de la pizarra e imágenes exportadas sin restaurar primero todo tu historial en la nube al almacenamiento local.',
    cloudLibrarySpeed: 'Velocidad',
    cloudLibraryAccel: 'Accel',
    cloudLibraryBoardDocuments: 'Documentos',
    cloudLibrarySavedImages: 'Imágenes guardadas',
